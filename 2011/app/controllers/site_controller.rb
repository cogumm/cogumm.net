class SiteController < ApplicationController
  ...
  # Used to redirect a users that enters "cogumm.net"
  # based on his IP.
...
#    File.open(blog_cache, 'w'){ |f| f.write(open('http://cogumm.net/blog/arquivos/rss.xml').read) } unless File.exist?(blog_cache)
